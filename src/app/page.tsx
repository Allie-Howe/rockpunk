...
const NewSection = () => {
  return (<>
    ...
    <svg id="visual" viewBox="0 0 900 350" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1"><path d="M0 310L225 195L450 316L675 97L900 245L900 0L675 0L450 0L225 0L0 0Z" fill="#ef4444" strokeLinecap="square" strokeLinejoin="bevel"></path></svg>
  </>)
}
